...
<body>
    <div class="invoice-box">
        <div class="car-items">
        	<div style="border: 1px solid black; border-bottom: none; text-align: center; font-size: 30px; padding: 20px; font-weight: bold;">LISTA DE CUENTAS CANCELADAS</div>
            <table>
                ...
                <tbody>
	                @foreach($accounts as $account)   
	                    <tr style="page-break-inside: avoid;">
                            ...
                            <td class="text-content">{{ $account['closing_date'] }}</td>
