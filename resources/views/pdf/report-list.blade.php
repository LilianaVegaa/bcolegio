    ...
    <div class="car-items">
      ...
      <table>
        ...
        <thead class="text-center" style="font-weight: bold;">
          <tr>
            @foreach($columns as $column)
              @if (mb_strtoupper($column, 'UTF-8') == "CITE")
                <td width="100px">{{ mb_strtoupper($column, 'UTF-8') }}</td>
              @else
        ...
        <tbody>
          ...
          @endforeach
          <tr>
            @if ($title == 'Total Importe Cotizaciones')
            ...
            <td style="font-weight: bold; font-size: 20px; text-align: right; padding-right: 20px;" colspan="{{ ($title == 'Cuentas por Cobrar') ? $size - 2 : $size }}">TOTAL (BS):</td>
            @endif
            @if ($title == 'Cuentas Canceladas')
            <td style="font-weight: bold; font-size: 20px; text-align: right; padding-right: 20px;" colspan="{{ ($title == 'Cuentas Canceladas') ? $size - 2 : $size }}">TOTAL (BS):</td>
            @endif
